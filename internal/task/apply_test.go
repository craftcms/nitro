		...
		},
		{
			...
			want: []nitro.Action{
				...
				},
				{
					Type:       "exec",
					UseSyscall: false,
					Args:       []string{"exec", "mytestmachine", "--", "sudo", "update-alternatives", "--set", "php", "/usr/bin/php7.4"},
				},
				{
					Type:       "exec",
					UseSyscall: false,
					Args:       []string{"exec", "mytestmachine", "--", "sudo", "update-alternatives", "--set", "phar", "/usr/bin/phar7.4"},
				},
				{
					Type:       "exec",
					UseSyscall: false,
