...
func TestInstallCommand_Run(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:     nil,
			expected: []string{"exec", "from-config-file", "--", "bash -c", "'sudo apt install -y php7.3 php7.3-mbstring php7.3-cli php7.3-curl php7.3-fpm php7.3-gd php7.3-intl php7.3-json php7.3-mysql php7.3-opcache php7.3-pgsql php7.3-zip php7.3-xml php-xdebug php-imagick'"},
			want:     0,
