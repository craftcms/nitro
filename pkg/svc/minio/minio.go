...
const (
	// Image is the image to use for the minio container
	Image = "docker.io/minio/minio:latest"

	// Host is the hostname for the minio container
	Host = "minio.service.nitro"

	// Label is the label value used to mark a container as a "minio" service
	Label = "minio"
)
